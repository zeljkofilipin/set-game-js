...
describe('Set game', function () {
  ...
  describe('sets', function () {
    ...
    it('should expand cards to possible sets', function () {
      var cards = [
        'diamond solid red 3',
        'oval open green 3',
        'oval solid green 2',
      ...
      assert.deepEqual(possibleSets, set.cardsToSets(cards));
    });

    it('should find sets in possible sets', function () {
      var sets = [
        ['diamond solid red 3',
          'oval solid green 2',
          'squiggle solid blue 1',],
      ...
      assert.deepEqual(sets, set.sets(possibleSets));
    });
